...
<div class="users index">
	...
	<table>
		<thead>
			<tr>
				...
				<th class="ib-col-datetime"><?php echo $this->Paginator->sort('UserTheme.theme_title', '学習テーマ'); ?></th>
	...
	<tr>
		...
		<td><div class="reader" title="<?php echo h($user['UserTheme']['theme_title']); ?>"><p><?php echo h($user['UserTheme']['theme_title']); ?>&nbsp;</p></div></td>
